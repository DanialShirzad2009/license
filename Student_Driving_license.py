...
import random
root = Tk()
root.title("Drivers Licencences")
...
def license():
    ...
    dob="2-11-78"
    pincode=547683
    address="9264 Apple,Dr"
    typeofvehicle=["Two wheeler", "Four wheeler"]

label_id['text']=str(id)
label_name['text']= name
label_dob['text']=dob
label_pin['text']=str(pincode)
label_address['text']=address
label_vehichle_type['text']=typeofvehicle
# Create a button

button1= Button(root, text="Show my drivers License", command=license)
